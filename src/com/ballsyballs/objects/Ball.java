package com.ballsyballs.objects;
...
public class Ball {
	...
	public void setAlive(boolean allive) {
		this.alive = allive;
	}
	...
	public void paintShape(Graphics g) {
		...
		GradientPaint ballPaint = new GradientPaint(this.getX(), this.getY(), this.getColor(),
				this.getX() + (this.getSize() / 2) + 50, this.getY() + (this.getSize() / 2) + 50, Color.RED);
